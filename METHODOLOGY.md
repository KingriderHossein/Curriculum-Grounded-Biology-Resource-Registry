...
- جلد باید با همان عنوان، ویرایش یا شابک Resource تطابق داشته باشد؛
- صرف وجود URL کافی نیست؛ تصویر باید در صفحهٔ واقعی GitHub با ابعاد قابل‌مشاهده render شود؛
- تغییر خاموش محتوای URL جلد باید در صورت امکان با hash یا کنترل معادل شناسایی شود؛
