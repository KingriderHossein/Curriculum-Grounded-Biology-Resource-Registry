...
مسیر از جریان اطلاعات ژنتیکی تا ماشین‌های همانندسازی، رونویسی، پردازش RNA، ترجمه، تنظیم ژن و سازمان ژنوم ادامه دارد. شاخه‌های تخصصی شامل:
...
مسیر از شواهد و منطق تکامل تا انتخاب طبیعی، ژنتیک جمعیت، تکامل مولکولی، فیلوژنتیک، گونه‌زایی و تاریخ تکاملی انسان ادامه دارد. شاخه‌های تخصصی شامل:
...
مسیر از ایمنی ذاتی و ارائه آنتی‌ژن تا زیست‌شناسی سلول‌های B و T، تحمل ایمنی، ایمنی مخاطی، ایمونومتابولیسم، عفونت، حافظه و پیری سیستم ایمنی ادامه دارد.
...
مسیر از هم‌ایستایی و تنظیم سلولی تا نوروفیزیولوژی، عضله و حرکت، گردش خون، تنفس، تنظیم اسمزی، تغذیه، درون‌ریز، تولیدمثل و سازگاری حرارتی–محیطی ادامه دارد و با نگاه تطبیقی میان جانوران سازمان یافته است.
...
مسیر از پیش‌نیاز زیستی و ورود مفهومی به بیوانفورماتیک، تا ژنومیک و ژنومیک عملکردی، مدل‌های احتمالاتی تحلیل توالی و سپس شاخه‌های تخصصی مانند مونتاژ ژنوم، ترنسکریپتومیک، فیلوژنومیک، واریانت، متاژنومیک، بیوانفورماتیک ساختاری، تک‌سلولی/چنداُمیکی و مدل‌سازی شبکه‌ای ادامه دارد.
