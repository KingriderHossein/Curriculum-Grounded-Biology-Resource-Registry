...
This file is a navigation index, not a status log.

| Truth | Authoritative location |
|---|---|
| Project purpose, subject-centered model, scope | [PROJECT_SPEC.md](../PROJECT_SPEC.md) |
...
| Optional curriculum mappings | `mappings/` when a mapping is useful |
